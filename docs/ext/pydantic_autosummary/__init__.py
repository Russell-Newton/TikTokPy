...
Has been modified to work with autodoc_pydantic, as per
https://github.com/mansenfranzen/autodoc_pydantic/issues/33#issuecomment-1085211704
    ...
    def get_items(self, names: List[str]) -> List[Tuple[str, str, str, str]]:
        ...
        for name in names:
            ...
            try:
                ...
                errors = list(
                    {"* %s: %s" % (type(e).__name__, e) for e in exc.exceptions}
                )
                logger.warning(
